...
const newPressBrake = `        {/* Press Brake Assembly (Right) */}
        <group position={[3.5, 0.5, -1.5]}>
          ...
          <mesh position={[0, 2.0, 0.18]} castShadow>
          ...
          {/* Angled middle section - Main Body */}
          <mesh position={[0, 0.5, 0]} castShadow>
            <boxGeometry args={[4.5, 1.5, 1.0]} />
            <meshStandardMaterial color="#5f6b7a" metalness={0.7} roughness={0.3} />
          </mesh>
          {/* Angled middle section - Front Slope */}
          <mesh position={[0, 0.5, 0.5]} castShadow rotation={[-Math.PI / 12, 0, 0]}>
          ...
          <mesh position={[2.26, -0.8, 0.25]} rotation={[0, 0, Math.PI / 2]}>
          ...
          <group position={[0, -1.35, 0.55]}>
            ...
            {/* Top flange */}
            <mesh position={[0, 0.075, -0.65]} castShadow>
              <boxGeometry args={[4.5, 0.15, 1.6]} />
              <meshStandardMaterial color="#8a95a5" metalness={0.8} roughness={0.2} />
            </mesh>
            {/* Top folded lip */}
            <mesh position={[0, -0.125, -1.375]} castShadow>
              <boxGeometry args={[4.5, 0.4, 0.15]} />
              <meshStandardMaterial color="#8a95a5" metalness={0.8} roughness={0.2} />
            </mesh>
            {/* Bottom flange */}
            <mesh position={[0, -1.725, -0.65]} castShadow>
              <boxGeometry args={[4.5, 0.15, 1.6]} />
              <meshStandardMaterial color="#8a95a5" metalness={0.8} roughness={0.2} />
            </mesh>
            {/* Bottom folded lip */}
            <mesh position={[0, -1.525, -1.375]} castShadow>
              <boxGeometry args={[4.5, 0.4, 0.15]} />
              <meshStandardMaterial color="#8a95a5" metalness={0.8} roughness={0.2} />
            </mesh>
            {/* Holes in the front face */}
            <mesh position={[-1.2, -0.5, 0.15]} rotation={[Math.PI / 2, 0, 0]}>
