...
function ProcessStepCard({ step }) {
  ...
  return (
    <div 
      className="min-w-[280px] lg:min-w-0 flex flex-col items-center text-center group snap-center"
      ...
      <div className="mb-10 relative">
        ...
        <div className="w-32 h-32 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] rounded-xl border-t border-gray-700 shadow-2xl flex items-center justify-center relative z-10 group-hover:-translate-y-2 transition-transform duration-500">
          ...
          <div className="w-16 h-16 relative z-20 pointer-events-none">
            <SvgComponent isHovered={isHovered} reducedMotion={false} />
          </div>
        </div>
    ...
    <section className="w-full bg-[#111315] py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="relative w-full">
          ...
          <div 
            className="flex flex-nowrap lg:grid lg:grid-cols-6 gap-6 lg:gap-4 overflow-x-auto pb-12 snap-x hide-scrollbar relative z-10"
